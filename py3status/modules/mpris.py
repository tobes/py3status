...
class Py3status:
    ...
    def _add_player(self, player_id):
        ...
        """
        try:
            player = self._dbus.get(player_id, '/org/mpris/MediaPlayer2')
            if player_id.startswith('org.mpris.MediaPlayer2'):
    ...
    def _get_players(self):
        ...
        for player in bus.ListNames():
            if player.startswith(':') or player.startswith('org.mpris.MediaPlayer2'):
